...
gerap = []
list_omegalul = []
# omega_lul= 0.06933914994245083
omega_lul = 0
for z in range(0,100):
	#important variables
	omega_lul = omega_lul+0.00000000001
	print("omega_lul", omega_lul)
	...
	akurasi =count/float(len(data_validasi_x)) 
	print(akurasi)
	gerap.append(akurasi)
	list_omegalul.append(omega_lul)

print("ASDSADASDA", len(gerap))
showGraph(gerap, list_omegalul)
#munculin scatter
